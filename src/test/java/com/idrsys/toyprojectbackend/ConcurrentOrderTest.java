...
public class ConcurrentOrderTest {
    ...
    private static final int[] goodsIds = {1, 1, 2, 2, 3, 4, 5, 2, 2, 6, 6, 7, 7, 8, 8, 9, 10};
    private static final String[] optVal1Values =
            {"M", "M","32", "34", "S", "", "L" , "32", "34", "100g", "200g", "R", "L", "300g", "200g", "200g", "5개"};
    private static final String[] optVal2Values = {"레드", "블루","블랙", "블루", "핑크", "", "", "블루", "블랙", "보통맛", "매운맛", "매운맛", "보통맛", "매운맛", "보통맛", "", ""};
